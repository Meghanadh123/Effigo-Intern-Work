...
public class ClientController 
{
	...
	{
		ModelAndView mv=new ModelAndView("test");//test is file name
		
		
		return mv;
	}
	@RequestMapping("/demo2")//By default GET method
	public ModelAndView demo2()//URI name & method name can be different
	{
		ModelAndView mv=new ModelAndView("main");//main is file name
	...
	{
		ModelAndView mv=new ModelAndView();
		mv.setViewName("profile");//profile is a jsp file
	...
	public ModelAndView demo10(@PathVariable("fname") String fname,@PathVariable("lname") String lname)
	{
