    ...
    <table>
        ...
        <c:forEach items="${empdata}" var="emp">
            <tr>
                ...
                <td> 
                   <a href='<c:url value="setstatus?id=${emp.id}&status=true"></c:url>' class="button">Active</a>
                   <a href='<c:url value="setstatus?id=${emp.id}&status=false"></c:url>' class="button">Inactive</a>
                </td>
            </tr>
        </c:forEach>
    </table>
